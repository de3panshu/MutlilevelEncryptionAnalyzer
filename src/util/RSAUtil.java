...
public class RSAUtil {
    ...
    public static PublicKey getPublicKey(String base64PublicKey){
        ...
        try{
            ...
            System.out.println("pub key1:"+keyFactory.generatePublic(keySpec));
            System.out.println("pub key2:"+keyFactory.generatePublic(keySpec));
            return publicKey;
...
//        System.out.println("Data byte:"+data.getBytes());
    ...
    public static void main(String[] args) throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException {
        try {
            ...
            String encryptedString2 = Base64.getEncoder().encodeToString(encrypt("Dhiraj is the author", publicKey));
